...
namespace Technosoftware.DaAeHdaClient
{
	...
	public struct OpcSpecification
	{
		...
		public static readonly OpcSpecification OPC_UA_10 = new OpcSpecification("EC10AFD8-9BC0-4828-B47E-B3D907F929B1", "Unified Architecture 1.00");

        /// <summary>OPC Xi 1.0.</summary>
		public static readonly OpcSpecification OPC_XI_10 = new OpcSpecification("25846B4D-0E07-41c3-9DA7-596F9010D2A4", "Express Interface 1.00");
		...
		{
			if (target != null && target.GetType() == typeof(OpcSpecification))
			{
