...
namespace SampleClients.Da.Subscription
{
    ...
    public class SubscriptionCreateDlg : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.subscriptionCtrl_ = new SubscriptionEditCtrl();
			...
			this.subscriptionCtrl_.Size = new System.Drawing.Size(246, 268);
			this.subscriptionCtrl_.TabIndex = 1;
			// 
			// BrowseCTRL
			// 
