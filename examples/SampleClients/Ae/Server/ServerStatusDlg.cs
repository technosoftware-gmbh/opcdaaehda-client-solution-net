...
namespace Technosoftware.AeSampleClient
{
    ...
    public class ServerStatusDlg : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.lastUpdateTimeLb_ = new System.Windows.Forms.Label();
			...
			// LastUpdateTimeLB
			// 
			this.lastUpdateTimeLb_.Location = new System.Drawing.Point(4, 124);
			this.lastUpdateTimeLb_.Name = "lastUpdateTimeLb_";
			this.lastUpdateTimeLb_.Size = new System.Drawing.Size(100, 20);
			this.lastUpdateTimeLb_.TabIndex = 19;
			this.lastUpdateTimeLb_.Text = "Last Update Time";
			this.lastUpdateTimeLb_.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// LastUpdateTimeTB
			// 
			this.lastUpdateTimeTb_.Location = new System.Drawing.Point(104, 124);
			this.lastUpdateTimeTb_.Name = "lastUpdateTimeTb_";
			this.lastUpdateTimeTb_.ReadOnly = true;
			this.lastUpdateTimeTb_.Size = new System.Drawing.Size(128, 20);
			this.lastUpdateTimeTb_.TabIndex = 20;
			this.lastUpdateTimeTb_.Text = "";
			// 
			// ServerStatusDlg
			// 
			...
			this.Controls.Add(this.lastUpdateTimeLb_);
